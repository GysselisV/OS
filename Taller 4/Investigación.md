...
8.1. ¿Cuál es la principal ventaja de usar microkernel en el diseño del OS? 
...
8.2. ¿Cómo interactúan los programas de usuario y los servicios del OS en una arquitectura basada en microkernel? 
...
8.3. ¿Cuáles son las desventajas de usar la arquitectura de microkernel? –
